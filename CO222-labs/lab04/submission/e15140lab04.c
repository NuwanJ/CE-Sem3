...
PLEASE COMPILE THIS WITH -lm TAG. 
Otherwise it shows the error "undefined reference to `sqrt'" on some compilers

	Author: Jaliyagoda A.J.N.M. (E15140)
...
void drawDonut2(int fgColor, int  bgColor, int r){
    ...
    // Method 2 : Using Circle Equation (Mathematical method)
